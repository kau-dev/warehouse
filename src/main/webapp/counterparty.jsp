...
<body style="background-color: rgb(77,77,77);">
    ...
    <div class="card mycard-s" id="content">
        <div class="card-body col-10" >"${counterparty.name}"
                                ...
                                <div class=" d-flex flex-column flex-xl-row">
                                    <div class="col">
                                        <div class="input-group text-break inputText">
                                            ...
                                            </div><input id="par_id" class="form-control flex-fill rounded-right rounded-left"
                                    ...
                                    <div class="col">
                                        <div class="input-group text-break inputText">
                                            ...
                                            <input id="par_label_name" class="form-control rounded-right rounded-left" type="text"
                                ...
                                <div class=" flex-column flex-sm-column flex-md-column flex-lg-column flex-xl-row">
                                    <div
                                        ...
                                        <div class="input-group text-break inputText">
                                            ...
                                            <input id="par_name" class="form-control flex-fill rounded-right rounded-left" type="text"
                                    ...
                                    <div class="col" style="max-width: 350px;">
                                        <div class="input-group text-break inputText">
                                            ...
                                            </div><input id="par_country" class="form-control rounded-right rounded-left" type="text"
                                ...
                                <div
                                    ...
                                    <div class="col" style="max-width: 350px;">
                                        <div class="input-group text-break inputText">
                                            ...
                                            </div><input id="par_company_number" class="form-control flex-fill rounded-right rounded-left"
                                    ...
                                    <div class="col col-xs" style="max-width: 300px;">
                                        <div class="input-group text-break inputText">
                                            <div class="input-group-prepend text-monospace input-group-addon"><span
                                                ...
                                                id="par_itin" class="form-control rounded-right rounded-left" type="text"
                                    ...
                                    <div class="col" style="max-width: 350px;">
                                        <div class="input-group text-break inputText">
                                            ...
                                            </div><input id="par_external_code" class="form-control rounded-right rounded-left" type="number"
                                    ...
                                    <div class="col" style="max-width: 350px;">
                                        <div class="input-group text-break inputText" >
                                            ...
                                            <input id="par_creation_date" class="form-control rounded-right rounded-left" type="date"
...
<script>
console.log(this.window.getParamValue('id') );
