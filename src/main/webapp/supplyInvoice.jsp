                                ...
                                <div class="col">
                                    <div class="row d-flex flex-column flex-xl-row">
                                        ...
                                        <div class="col col-xs" style="max-width: 280px;">
                                            <div class="input-group text-break inputText" id="birthdaydate">
                                                ...
                                                <input class="form-control rounded-right rounded-left" type="date"
                                                       data-toggle="tooltip"
                                                       id="" autocomplete="off"
                                                       style="min-width: 140px;margin-left: -4px;"
                                                       title="Создан" value="2002-11-11">
                                                <div class="input-group-append"></div>
                                            </div>
                                        </div>
                                        <div class="col col-xs" style="max-width: 700px;">
                                            <div class="input-group text-break inputText">
                                                <div class="input-group-prepend text-monospace input-group-addon"><span
                                                        class="input-group-text d-none d-lg-block">Номер документа поставщика</span>
                                                </div>
                                                <input class="form-control rounded-right rounded-left" type="text"
                                                       data-bs-tooltip=""
                                                       style="margin-left: -4px; max-width: 150px"
                                                       title="Номер документа поставщика"
                                                       value="53423">
                                                <div class=" text-monospace input-group-addon"
                                                     style="margin-left: 10px "><span
                                                        class="input-group-text d-none d-lg-block">от</span></div>
                                                <input class="form-control rounded-right rounded-left" type="date"
                                                       data-toggle="tooltip"
                                                       id="passport_date" autocomplete="off"
                                                       style="min-width: 150px; max-width: 200px;margin-left: -4px;"
                                                       title="Создан" value="2002-11-11">
                                            </div>
                                        </div>
                                        <div class="col" style="max-width: 320px">
                                            <div class="input-group text-break inputText" id="social_num">
                                                ...
                                                <input class="form-control rounded-right rounded-left" type="number"
                                                       data-toggle="tooltip"
                                                       data-bs-tooltip="" value="56465463322" inputmode="numeric"
                                                       autocomplete="off"
                                    ...
                                    <div class="row flex-column flex-sm-column flex-md-column flex-lg-column flex-xl-row">
                                        <div class="col flex-column flex-sm-column flex-md-column flex-lg-column flex-xl-column">
                                            <div class="input-group text-break inputText" id="position">
                                                <div class="input-group-prepend text-monospace input-group-addon"><span
                                                        class="input-group-text d-none d-lg-block">Контрагент</span>
                                                </div>
                                                <input class="form-control flex-fill rounded-right rounded-left"
                                                       type="text"
                                                       data-toggle="tooltip" data-bs-tooltip=""
                                                       value="ТОВ КИИВСЬКИЙ ВЕНТИЛЯЦИЙНИЙ ЗАВОД"
                                        ...
                                        <div class="col" style="max-width: 500px">
                                            <div class="input-group text-break inputText" id="office">
                                                <div class="input-group-prepend text-monospace input-group-addon"><span
                                                        class="input-group-text d-none d-lg-block">Артикул документа</span>
                                                </div>
                                                <input class="form-control rounded-right rounded-left" type="text"
                                                       data-toggle="tooltip"
                                                       data-bs-tooltip="" style="margin-left: -4px;"
                                                       value="DNPR-SUP-032453322" title="Артикул">
                                                <div class="input-group-append">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div
                                        ...
                                        <div class="col col-xs" style="max-width: 470px;">
                                            <div class="input-group text-break inputText" id="passport_ser">
                                                ...
                                                <input class="form-control rounded-right rounded-left" type="text"
                                                       data-toggle="tooltip"
                                                       data-bs-tooltip="" value="Основной" autocomplete="off"
                                                       maxlength="12" minlength="2"
                                                       style="margin-left: -4px;min-width: 88px;" title="Склад">
                                                <div class="input-group-append">
                                                    <button class="btn btn-primary fa fa-times d-none d-lg-block"
                                                            type="icon"
                                        ...
                                        <div class="col col-sm" style="max-width: 294px;">
                                            <div class="input-group text-break inputText" id="passport_num">
                                                ...
                                                <input class="form-control rounded-right rounded-left"
                                                       data-toggle="tooltip"
                                                       data-bs-tooltip="" style="margin-left: -4px;" value="Оформление"
                                                       title="Статус">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="container-fluid" style="margin-top: 20px">
                                        <ul id="clothingnav1" class="nav nav-tabs" role="tablist">
                                            <li class="nav-item"><a class="nav-link active" href="#home1" id="hometab1"
                                                                    role="tab"
                                                                    data-toggle="tab" aria-controls="home"
                                                                    aria-expanded="true">Товары</a></li>
                                            <li class="nav-item"><a class="nav-link" href="#paneTwo1" role="tab"
                                                                    id="hatstab1"
                                                                    data-toggle="tab"
                                                                    aria-controls="hats">Дополнительно</a></li>
                                            <!-- Dropdown -->
                                            <!--
                                        ...
                                        <div id="clothingnavcontent1" class="tab-content">
                                            <div role="tabpanel" class="tab-pane fade show active mycard" id="home1"
                                                ...
                                                <table class="mytable">
                                                    <div class="row" style="padding-left:15px; padding-bottom: 10px;">
                                                        <div class="btn-toolbar" role="toolbar">
                                                            ...
                                                            <div class="btn-group mr-2" role="group">
                                                                <button type="button" class="btn btn-secondary">Найти
                                                                </button>
                                                            </div>
                                                            <div class="btn-group mr-2" role="group">
                                                                <button type="button" class="btn btn-secondary">
                                                            ...
                                                            <div class="btn-group mr-2" role="group">
                                                                <button type="button" class="btn btn-secondary">Найти по
                                                                    штрихкоду
                                                                </button>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <tbody class="mytable">
                                                    <tr class="mytable">
                                                        <th class="mytd" style="width:50px; margin-left:10px;"
                                                            scope="col">N
                                                        </th>
                                                        <th class="mytd" style="width:75%; margin-left:10px;"
                                                            scope="col">Наименование
                                                        </th>
                                                        <th class="mytd" style="width:10%; margin-left:10px;"
                                                    ...
                                                    <tr class="mytable">
                                                        ...
                                                        <td>
                                                            <%--                                    <input class="custom-select" type="text" id="gooditem" list="selectgoods" role="combobox"--%>
                                                            ...
                                                            <div class="form-row mb-2 ">
                                                                ...
                                                                <div class="col">
                                                                    ...
                                                                    <div class="dropdown">
                                                                        <!-- DROPDOWN > TOGGLER -->
                                                                        <button class="btn btn-dark btn-block rounded-0 my_work_container" type="button" id="dropDownButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                        ...
                                                                        <!-- DROPDOWN > MENU -->
                                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-scrollable w-100 rounded-0 my_work_container"
                                                                             aria-labelledby="dropDownButton"
                                                                             id="dropDownMenu">

                                                                            <div class="col mb-2">
                                                                                <input type="text" class="form-control rounded-0"  id="inputTextCombo1" aria-describedby="inputText1Desc">
                                                                            </div>
                                                        ...
                                                        <td>
                                                            <input type="number" min="0" max="999999999" id="qtyitem"
                                                                   style="background-color:rgba(99,99,99,1.00);border: 0px; width: 100%; color: white;">
                                                        </td>
                                                    ...
                                                    <tr class="mytable">
                                                        <td><label style="width:50px; margin-left:10px;">Итого</label>
                                                        </td>
                                                        <td>&nbsp;</td>
                                                        <td>&nbsp;</td>
                                                        <td>&nbsp;</td>
...
<!-- Modal -->
    ...
    <%--</div>--%>
<script>
    reloadComboBoxData('dropDownMenuList', '/api/good/get-allItems');
    myComboBoxAction('inputTextCombo1', 'dropDownMenu','dropDownMenuList','/api/good/get-allItems?group=false');
