...
<body id="page-top" style="background-color: rgb(123,123,123);">
    <div class="border-dark shadow-lg d-flex d-xl-flex justify-content-center justify-content-xl-center" id="wrapper"
        ...
        <nav
            ...
            <div class="container-fluid d-flex flex-column p-0 ">
                <a id="tasksList"
                    ...
                    <div class="sidebar-brand-text mx-0"></div><img
        ...
        <div class="d-flex flex-column" id="content-wrapper" style="background-color: rgb(77,77,77); overflow: hidden;">
            <div id="content">
                <nav class="navbar navbar-light navbar-expand shadow  topbar static-top mycard-s my-2" id="content">
                    <div class="container-fluid"><button class="btn btn-link bg-white d-md-none rounded-circle mr-3"
                ...
                <iframe id="contentPage" class="iframe_child" src="..${contextPath}/tasksList.jsp" width="100%" height="100%"
