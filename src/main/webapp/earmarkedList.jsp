...
<head>
    ...
    <title>Резервирование товара</title>
    ...
    <div class="container-fluid myCardContainer">
        <div class="row">
            <div class="col d-xl-flex justify-content-xl-center align-items-xl-start"><span
                    ...
                    style="color: rgb(205,190,8);font-weight: bold;font-size: 24px;">Резервирование товара</span></div>
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item border-left-info-await" style="background-color: rgb(99,99,99);">
                            <div class="row align-items-center no-gutters">
                                <div class="col mr-2">
                                    <h6 class="mb-0"><strong>Резервирование товара 1044 от 15.04.2022</strong></h6><span
                                        class="text-xs">тветственный (Контрагент)</span>
                                </div>
                                <div class="col mr-2">
                        ...
                        <li class="list-group-item border-left-info-await" style="background-color: rgb(99,99,99);">
                            <div class="row align-items-center no-gutters">
                                <div class="col mr-2">
                                    <h6 class="mb-0"><strong>Резервирование товара 1045 от 15.04.2022</strong></h6><span
                                        class="text-xs">тветственный (Контрагент)</span>
                                </div>
                                <div class="col mr-2">
                                    <h6 class="mb-0"><strong>С места</strong></h6><span class="text-xs">контактное
                        ...
                        <li class="list-group-item border-left-info-await" style="background-color: rgb(99,99,99);">
                            <div class="row align-items-center no-gutters">
                                <div class="col mr-2">
                                    <h6 class="mb-0"><strong>Резервирование товара 1046 от 15.04.2022</strong></h6><span
                                        class="text-xs">тветственный (Контрагент)</span>
                                </div>
                                <div class="col mr-2">
                                    <h6 class="mb-0"><strong>С места</strong></h6><span class="text-xs">контактное
                        ...
                        <li class="list-group-item border-left-info-await" style="background-color: rgb(99,99,99);">
                            <div class="row align-items-center no-gutters">
                                <div class="col mr-2">
                                    <h6 class="mb-0"><strong>Резервирование товара 1047 от 15.04.2022</strong></h6><span
                                        class="text-xs">тветственный (Контрагент)</span>
                                </div>
                                <div class="col mr-2">
                                    <h6 class="mb-0"><strong>С места</strong></h6><span class="text-xs">контактное
                        ...
                        <li class="list-group-item border-left-info-await" style="background-color: rgb(99,99,99);">
                            <div class="row align-items-center no-gutters">
                                <div class="col mr-2">
                                    <h6 class="mb-0"><strong>Резервирование товара 1048 от 15.04.2022</strong></h6><span
                                        class="text-xs">тветственный (Контрагент)</span>
                                </div>
                                <div class="col mr-2">
                                    <h6 class="mb-0"><strong>С места</strong></h6><span class="text-xs">контактное
